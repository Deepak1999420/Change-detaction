...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        for (reference, testimg), mask in tqdm.tqdm(test_loader):
            ...
            #cv2.imwrite(f"/home/user/temporal_datasets/Tiny_model_4_CD/sample_result2/{count}act.png",mask[0]*255)
            #cv2.imwrite(f"/home/user/temporal_datasets/Tiny_model_4_CD/sample_result2/{count}per.png",bin_genmask[0]*255)
